      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="<?php echo base_url('assets/images/logo.png'); ?>" data-expand="<?php echo base_url('assets/images/logo.png'); ?>" data-collapse="<?php echo base_url('assets/images/logo.png'); ?>" class="brand-logo" height="40"></a></li>
